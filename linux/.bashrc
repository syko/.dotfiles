...
alias git_mbranch='git symbolic-ref refs/remotes/origin/HEAD | sed "s@^refs/remotes/origin/@@"'
alias s='git status -sb'
alias co='git-fuzzy-co'
alias m='git co $(git_mbranch)'
...
alias glmb='gl `git merge-base $(git_mbranch) HEAD`..'
alias ghreset='git reset --hard HEAD'
alias ghresetsoft='git reset --soft HEAD'
alias ghresetmixed='git reset --soft HEAD'
...
alias grim='git rebase -i $(git_mbranch)'
alias gprim='git co $(git_mbranch) && gpl && git co - && git rebase -i $(git_mbranch)'
alias grm='git rebase $(git_mbranch)'
alias gprm='git co $(git_mbranch) && gpl && git co - && git rebase $(git_mbranch)'
alias giddy="git"
